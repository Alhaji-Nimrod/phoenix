# Pls work with this simplified code:                                                             #Build an application that extracts phone number, email and link from a website. 
#This application should run as an executable file and should ask for the file name, 
#extract email etc also store the extracted email in a file separately.
